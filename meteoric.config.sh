...
APP_HOST=assetManager.brentjanderson.com
...
EC2_PEM_FILE=~/.ssh/aws_juicy.pem

# What's your project's Git repo?
GIT_URL=git://github.com/brentjanderson/assetManager.git
...
MONGO_URL=mongodb://meteor:UjfHiosPVc8BevFLPgggNgkXuNG2uC@paulo.mongohq.com:10074/Meservy
